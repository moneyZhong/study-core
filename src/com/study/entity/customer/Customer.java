package com.study.entity.customer;
...
public class Customer {
    ...
    private String investMediateFlag;

    private String borrowMediateFlag;

    private String randomNo;

    private Date resetTime;

    private String yeepayAuth;
    ...
    public String getInvestMediateFlag() {
        return investMediateFlag;
    }

    public void setInvestMediateFlag(String investMediateFlag) {
        this.investMediateFlag = investMediateFlag == null ? null : investMediateFlag.trim();
    }

    public String getBorrowMediateFlag() {
        return borrowMediateFlag;
    }

    public void setBorrowMediateFlag(String borrowMediateFlag) {
        this.borrowMediateFlag = borrowMediateFlag == null ? null : borrowMediateFlag.trim();
    }
    ...
    public void setYeepayAuth(String yeepayAuth) {
        this.yeepayAuth = yeepayAuth == null ? null : yeepayAuth.trim();
    }
}